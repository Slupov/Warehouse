        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    VoucherType = table.Column<int>(nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricesPrecisionUnits = table.Column<byte>(nullable: false, defaultValue: (byte)2),
                    PricesIncludeVAT = table.Column<bool>(nullable: true, defaultValue: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationSettings_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    IncomeExpenseType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MesureUnits_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentPrint = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForMonths = table.Column<int>(nullable: false),
                    ForUsers = table.Column<int>(nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
                    PaymentStatus = table.Column<int>(nullable: false, defaultValue: 3)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Partners_Contacts_ContactsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    BaseBarcode = table.Column<string>(nullable: true),
                    MeasureUnitId = table.Column<int>(nullable: false),
                    ProductGroupId = table.Column<int>(nullable: false),
                    RetailPrice = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
                    WholesalePrice = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
                    DistributorPrice = table.Column<decimal>(type: "decimal(18,5)", nullable: false),
                    MinimalQuantity = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_MesureUnits_MeasureUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSettings_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MesureUnits_CompanyId",
                table: "MesureUnits",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Partners_ContactsId",
                table: "Partners",
                column: "ContactsId");
